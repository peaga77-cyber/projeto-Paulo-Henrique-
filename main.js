function getProjects() {
  const urlGitHub = "https://api.github.com/users/Peaga77-cibernético/repos"; // Inserir o nome de usuário do seu github
...
function showProjects(data) {
  ...
  data.forEach((repo) => {
    ...
    a.href = repo["https://github.com/peaga77-cyber?tab=repositories"]; // Link para o repositório no GitHub
    a.target = "_blank";
